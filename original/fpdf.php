...
function __construct($orientation='P', $unit='mm', $size='A4')
{
    ...
    $this->U=0;
    $this->HREF='';
    $this->fontlist=array('arial', 'times', 'courier', 'helvetica', 'symbol', 'Calibri-Light');
...
protected function hex2dec($couleur = "#000000"){
...
/* Conversation */
protected  function txtentities($html){
...
public function WriteHTML($html, $h)
{
    //HTML parser
    ...
    foreach($a as $i=>$e)
    {
        if($i%2==0)
        {
            ...
            if($this->HREF)
                ...
                $this->Write($h,stripslashes($this->txtentities($e)));
        }
        else
        {
            //Tag
